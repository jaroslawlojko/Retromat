...
<body onload="JavaScript:init()">
    ...
    <div class="plan-header">
        <div class="content">
            <div class="inner" style="justify-content: space-around + unsafe;">
                <div class="ids-display">
                    <div class="print-header font-serif">
                        Retromat.org – by Corinna Baldauf
                    </div>
    ...
    <div class="plan-header">
        <div class="content">
            <div class="inner" style="justify-content: space-between + unsafe;">
                <div class="ids-display">
                    <div class="print-header font-serif">
                        Retromat.org – by Corinna Baldauf
                    </div>
    ...
    <div class="plan-header">
        <div class="content">
            <div class="inner" style="align-content: center">
                <div class="ids-display">
                    <div class="print-header font-serif">
                        Retromat.org – by Corinna Baldauf
                    </div>
